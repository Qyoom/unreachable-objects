...
const svgSize = {
  ...
  height: windowSize.height * 0.8 // 0.90
}

const vertSpacer = 110; // 115; // 120; // approx space between horizontal lines
const horizSpacer = 85; // 90; // approx space between vertical lines
