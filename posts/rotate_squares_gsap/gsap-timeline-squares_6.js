console.log('gsap-timeline-squares_6.js');
...
function GsapSquaresDrawing() { // module, closure
  ...
  const svgSize = windowSize.width < windowSize.height ? 
    windowSize.width * 0.90 : 
    windowSize.height * 0.82;
    
  const qtySquares = svgSize > 500 ? 25 : 20;
  const stepSize = (svgSize / qtySquares) / 2;
  ...
  function makeSquareData() {
    ...
    // console.log(`squareData.length: ${squareData.length}`);
  }
